...
_Replace each "TODO" below with actual content for your project. Add, remove, or rename sections as needed — this is your space._
...
TODO: List languages, frameworks, runtime, database, testing tools.

### Project Structure

TODO: List key directories and their purpose.

### Conventions

TODO: Define coding standards, naming conventions, patterns.

### Commands

TODO: List build, test, dev, and deploy commands.

### Key Files

TODO: Point out the most important files an AI agent should know about.

### Additional Rules

TODO: Add any project-specific rules that AI agents must follow.
